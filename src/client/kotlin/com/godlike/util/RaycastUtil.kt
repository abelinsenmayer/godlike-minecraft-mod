...
//    val lookVec = camera.getViewVector(1.0f)
//    val from = camera.position()
//    val to = camera.position().add(lookVec.x * MAX_RAYCAST_DISTANCE, lookVec.y * MAX_RAYCAST_DISTANCE, lookVec.z * MAX_RAYCAST_DISTANCE)

//    val hit = Minecraft.getInstance().player!!.level().clip(
//        ClipContext(
//            from,
//            to,
